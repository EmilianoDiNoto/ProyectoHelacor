...
CREATE TABLE Inventory (
    ...
    CONSTRAINT FK_Inventory_Material FOREIGN KEY (MaterialID) REFERENCES Materials(MaterialID)
);
GO
...
CREATE TABLE RetainedMaterials (
    ...
    CONSTRAINT FK_Retained_Material FOREIGN KEY (MaterialID) REFERENCES Materials(MaterialID)
);
GO
...
CREATE TABLE DiscardedMaterials (
    ...
    CONSTRAINT FK_Discarded_Material FOREIGN KEY (MaterialID) REFERENCES Materials(MaterialID)
);
GO
...
CREATE TABLE ProductionMaterials (
    ...
    BatchNumber NVARCHAR(50),
    CONSTRAINT FK_ProductionMaterials_Order FOREIGN KEY (OrderID) REFERENCES ProductionOrders(OrderID),
    CONSTRAINT FK_ProductionMaterials_Material FOREIGN KEY (MaterialID) REFERENCES Materials(MaterialID)
);
GO
